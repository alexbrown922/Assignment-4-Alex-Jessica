...
mean_lobster_tbl <- mean_lobster_size %>% 
  kable(col.names = c("Site", "Mean Lobster Carapace Length (mm)", "Standard Deviation (mm)"),
        caption = "Mean Lobster Sizes at 5 Locations in 2017. Researchers collected Panulirus interruptus lobster abundance in 2017 at the sites of Arroyo Quemado (AQUE), Naples Reef (NAPL), Mohawk Reef (MOHK), Isla Vista (IVEE), and Carpinteria (CARP). Listed are the average carapace length (mm) of lobsters collected at each location and the standard deviation of the samples taken at each location. Data source: Reed, D., Santa Barbara Coastal Long Term Ecological Research Project.") %>% 
